...
const About = () => {
  return (
    <section className="league-spartan mt-56 about-bg w-screen sm:h-max" id="AboutSection">
      {/* <img
          src="./images/wave-haikei.svg"
          className="absolute opacity-20"
        ></img> */}
      <div className="h-vh place-content-evenly text-[#fffdff] text-center">
      ...
      <p className="">TipTank, your platform for directly supporting the creators you admire! Our mission is to empower artists, writers, musicians, educators, and other creatives by providing a seamless way for fans to show appreciation for their work through tips and contributions.</p>

      <p className="mt-8">In today’s fast-paced digital world, creators put countless hours into producing valuable content, often without the security of a steady income. TipTank addresses this by offering a decentralized, user-driven space where fans can easily tip creators as a way to recognize and support their efforts. Unlike traditional platforms, TipTank operates on the blockchain, ensuring transparency, lower fees, and a fairer system that benefits creators more directly.</p>
      </div>
      {/* <div className="absolute w-[18%] mt-20 opacity-80">
        <img src="./images/aboutcreator1.jpg" className="rounded-xl shadow-2xl"></img>
      </div> */}
      {/* <div className="absolute w-[16%] mt-36 opacity-70 place-self-end">
        <img src="./images/aboutcreator2.jpg" className="rounded-xl shadow-2xl"></img>
      </div> */}
      </div>
      <div className="grid grid-cols-1 gap-12 mt-12 flex justify-center text-center leading-loose place-items-stretch font-light">
        <div className="w-[70%] place-self-center p-16 bg-[#6ead3d] text-[#00302e] rounded-xl shadow-2xl">
        <img
        ...
        <div className="w-[70%] place-self-center p-16 bg-[#6ead3d] text-[#00302e] border-none border-4 rounded-xl shadow-2xl">
