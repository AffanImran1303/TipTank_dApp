  ...
  return (
    <section className="league-spartan mt-12 h-max" id="AboutSection">
      <div className="place-content-evenly text-center text-[#fffdff]">
        <p className="text-4xl league-spartan font-bold transition ease-in-out hover:delay-650 hover:text-[#6ead3d] hover:scale-110 sm:text-5xl md:text-8xl ">
          About TipTank
        </p>
      ...
      <div className="place-items-center grid grid-cols-1 gap-8 sm:grid-cols-2 text-center leading-loose font-light sm:mt-12">
