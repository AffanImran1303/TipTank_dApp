const GiveATipButton=()=>{
    return(
        <>
        <div className="btn btn-ghost bg-[#6ead3d] border-0 text-[#fffdff] w-64 transition ease-in-out delay-150 hover:bg-[#0c4727] hover:scale-110">
